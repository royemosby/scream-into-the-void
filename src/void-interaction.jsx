...
export function Void(){
  ...
  const responses = [
      ...
      "The void received your praintive cry. It will respond when you next transition between wakefulness and sleep.",
      "Your message perfectly reflects the timeless wisdom of Wheel of Fortune contestants screaming letter guesses.",
      ...
      "Feeling of melancholy are normal. You have been assigned by the morn an unloved stranger's death.",
